...
2. connect your OpenShift clusters to Dynatrace to take advantage of the dedicated OpenShift overview page  (using ActiveGate)
3. OpenShift CI/CD with Jenkins, Sonatype Nexus etc
4. Publishing artifacts to Sonatype Nexus using Jenkins Pipelines
5. End to end monitoring for proprietary Java frameworks (using https://mvnrepository.com/artifact/com.dynatrace.oneagent.sdk.java/oneagent-sdk)
