...
----
 ...
 6. Automate Quality Gates - Jenkins / Dynatrace integration - Performance Signature
 ...
 7. Automate Quality Gates - Tekton Pipelines with Dynatrace-CLI running in containers using podman
 
 8. Deploy Ansible Tower on baremetal
 
 9. Optional: Deploy Ansible Tower 3.7.1 on OpenShift 4.4
 
10. Ansible/Z and mainframe monitoring (https://www.dynatrace.com/technologies/mainframe-monitoring/)
...
== Tekton Pipeline CI/CD Tekton Pipelines CI/CD with Dynatrace-CLI running in containers using podman
...
(using podman, see https://github.com/marcredhat/dynatrace/blob/master/build.sh),
...
== Ansible/Z and mainframe monitoring (https://www.dynatrace.com/technologies/mainframe-monitoring/)
