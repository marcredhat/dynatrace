...
----
keptn create project sockshopgate --shipyard=./shipyard-quality-gates.yaml --git-token=Cxx6CFg-Bs9pt8TZAEzw --git-user=marcredhat  --git-remote-url=https://gitlab.com/marcredhat/dynatrace-pipeline
Starting to create project
Handling connection for 8080
